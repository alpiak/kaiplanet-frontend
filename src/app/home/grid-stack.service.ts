...
export class GridStackService {
    ...
    private widgets: Widget[] = [
        ...
        // { x: 8, y: 6, width: 3, height: 4, type: "sns", config: { types: [ { id: "weibo", text: "Weibo", src: "https://passport.weibo.cn/signin/welcome" }, { id: "mop", text: "Mop", src: "http://3g3.mop.com/login.html" } ] } },
